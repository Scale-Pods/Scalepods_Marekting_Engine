    ...
    entries: [
      ...
      },
      {
        ...
        steps: [
          ...
          '"Recent" further down the page holds every trend-anchored generation made from the Trends page — click one to see the full plan it produced and which trend(s) it came from.',
        ],
        tip: 'This is a gate, not a formality — content generation stays locked until a strategy is approved. A "Recent" entry is a saved reference only; it never becomes the active strategy on its own.',
      },
    ],
  },
  {
