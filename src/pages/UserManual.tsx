    ...
    entries: [
      ...
      },
      {
        ...
        steps: [
          ...
          'A scan runs automatically every 24 hours. To run one immediately, use "Run manual scan" and pick which platforms to scan.',
          'Read the ranked list — each card links out to the real source so you can check it yourself.',
          'To act on a trend: "General Strategy" builds a marketing strategy anchored on it, or send it to AI Studio to make a post about it.',
        ],
        tip: 'AI Studio only offers trends from the last 30 days — older signals have usually been replaced by a newer scan.',
      },
      {
        id: 'strategy',
        label: 'Strategy',
        ...
        steps: [
          'Use "Regenerate all" to build the first strategy.',
          'Read the AI insights, the content-pillar mix and the platform mix.',
          'Edit any section by hand, or regenerate just that one section if you do not like it.',
          'Approve the strategy when you are happy with it.',
        ],
        tip: 'This is a gate, not a formality — content generation stays locked until a strategy is approved.',
      },
    ],
  },
  {
